        ...
        <div class="right-menu list-inline no-margin-bottom">
          ...
          <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink2" href="<?php echo site_url('recursos/'); ?>http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link tasks-toggle"><i class="icon-new-file"></i><span class="badge dashbg-3">9</span></a>
            <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list"><a href="#" class="dropdown-item">
              ...
              </a><a href="<?php echo site_url('recursos/'); ?>#" class="dropdown-item">
              ...
              </a><a href="<?php echo site_url('recursos/'); ?>#" class="dropdown-item text-center"> <strong>See All Tasks <i class="fa fa-angle-right"></i></strong></a>
            </div>
          </div>
          ...
          <!-- Megamenu end     -->
          <!-- Languages dropdown    -->
          <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="<?php echo site_url('recursos/'); ?>img/flags/16/GB.png" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
            <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="<?php echo site_url('recursos/'); ?>#" class="dropdown-item"> <img src="img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a rel="nofollow" href="#" class="dropdown-item"> <img src="<?php echo site_url('recursos/'); ?>img/flags/16/FR.png" alt="English" class="mr-2"><span>French </span></a></div>
          </div>
          <!-- Log out               -->
  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <div class="sidebar-header d-flex align-items-center">
        <div class="avatar"><img src="<?php echo site_url('recursos/'); ?>img/AmandaDev.jpg" alt="..." class="img-fluid rounded-circle"></div>
        <div class="title">
          <h1 class="h5">Amanda Farias</h1>
          <p>Dev.</p>
        </div>
      </div>
      ...
      <footer class="footer">
        <div class="footer__block block no-margin-bottom">
          <div class="container-fluid text-center">
            ...
            <p class="no-margin-bottom"><?php echo date('Y') ?> &copy; Your company. Download From <a target="_blank" href="<?php echo site_url('recursos/'); ?>https://templateshub.net">Templates Hub</a>.</p>
          </div>
        </div>
      </footer>
    </div>
