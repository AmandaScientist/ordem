<div class="form-group">
    ...
    <input type="text" name="nome" placeholder="Insira o nome" class="form-control" value="<?php echo esc($usuario->nome); ?>">
</div>
...
<div class="custom_control custom-checkbox">
    ...
    <label class="custom-control-label ml-4" for="ativo">Usuário ativo</label>
